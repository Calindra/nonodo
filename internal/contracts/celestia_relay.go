...
// RelayShares is a paid mutator transaction binding the contract method 0x98982389.
//
// Solidity: function relayShares(address _dapp, (bytes[],(uint256,uint256,((bytes1,bytes28),(bytes1,bytes28),bytes32)[])[],(bytes1,bytes28),((bytes1,bytes28),(bytes1,bytes28),bytes32)[],(bytes32[],uint256,uint256)[],(uint256,(uint256,bytes32),(bytes32[],uint256,uint256))) _proof, bytes _execLayerData) returns(bytes32)
func (_CelestiaRelay *CelestiaRelayTransactor) RelayShares(opts *bind.TransactOpts, _dapp common.Address, _proof SharesProof, _execLayerData []byte) (*types.Transaction, error) {
	return _CelestiaRelay.contract.Transact(opts, "relayShares", _dapp, _proof, _execLayerData)
}

// RelayShares is a paid mutator transaction binding the contract method 0x98982389.
//
// Solidity: function relayShares(address _dapp, (bytes[],(uint256,uint256,((bytes1,bytes28),(bytes1,bytes28),bytes32)[])[],(bytes1,bytes28),((bytes1,bytes28),(bytes1,bytes28),bytes32)[],(bytes32[],uint256,uint256)[],(uint256,(uint256,bytes32),(bytes32[],uint256,uint256))) _proof, bytes _execLayerData) returns(bytes32)
func (_CelestiaRelay *CelestiaRelaySession) RelayShares(_dapp common.Address, _proof SharesProof, _execLayerData []byte) (*types.Transaction, error) {
	return _CelestiaRelay.Contract.RelayShares(&_CelestiaRelay.TransactOpts, _dapp, _proof, _execLayerData)
}

// RelayShares is a paid mutator transaction binding the contract method 0x98982389.
//
// Solidity: function relayShares(address _dapp, (bytes[],(uint256,uint256,((bytes1,bytes28),(bytes1,bytes28),bytes32)[])[],(bytes1,bytes28),((bytes1,bytes28),(bytes1,bytes28),bytes32)[],(bytes32[],uint256,uint256)[],(uint256,(uint256,bytes32),(bytes32[],uint256,uint256))) _proof, bytes _execLayerData) returns(bytes32)
func (_CelestiaRelay *CelestiaRelayTransactorSession) RelayShares(_dapp common.Address, _proof SharesProof, _execLayerData []byte) (*types.Transaction, error) {
	return _CelestiaRelay.Contract.RelayShares(&_CelestiaRelay.TransactOpts, _dapp, _proof, _execLayerData)
}
